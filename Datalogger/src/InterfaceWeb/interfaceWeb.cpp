...
namespace InterfaceWeb
{
    ...
    void sendIDControlador()
    {
        ...
        client.println(myConfig::config.getNomeControlador());
        client.println("</div>");
        client.println("<div class=\"network-info\">");
        client.println("<b>Datalogger</b> <br>");
    ...
    void sendTitleAndMenu()
    {
        ...
        if(mySerial::getErrorStatus() == NO_ERROR)
        {
            client.println("<div class=\"dotgreen\"></div>");    
        }
        else
    ...
    void sendHome()
    {
        ...
        client.print(myConfig::config.getColheita());
        client.println("</span>");
        client.println("</div>");
        client.println("<div class=\"space-before\"></div>");
        client.println("<br>");
    ...
    void sendConfigControlador()
    {
        ...
        client.println(String("<input type=\"text\" id=\"nome\" name=\"nome\" placeholder=\"") + myConfig::config.getNomeControlador() + String("\" value= \"") + myConfig::config.getNomeControlador() + String("\" class=\"form-field\">"));
        client.println("<br>");
        client.println("<label for=\"nomeColheita\" class=\"form-label-medio\">Colheita:</label>");
        client.println(String("<input type=\"text\" id=\"nomeColheita\" name=\"nomeColheita\" placeholder=\"") + myConfig::config.getColheita() + String("\" value= \"") + myConfig::config.getColheita() + String("\" class=\"form-field\">"));
        client.println("<br>");
        ...
        client.println("<br>");
        client.println(String("<input type=\"text\" id=\"master\" name=\"master\" value=\"") + myConfig::config.getHostMaster() + String("\" class=\"form-field\">"));
        client.println("<br>");
        client.println("<div class=\"space-before\"></div>");
        client.println("<label for=\"sync\" class=\"form-label-x-longo\">Sincronizar com o servidor NTP:</label>");
        client.println("<br>");
        client.println(String("<input type=\"text\" id=\"sync\" name=\"sync\"value=\"") + myConfig::config.getServidorNTP() + String("\" class=\"form-field\">"));
        ...
        client.println(String("<input type=\"text\" id=\"ssid\" name=\"ssid\" placeholder=\"") + myConfig::config.getSSID() + String("\" class=\"form-field\">"));
        client.println("<br>");
        client.println("<label for=\"senha\" class=\"form-label-curto\">Senha:</label>");
        client.println(String("<input type=\"password\" id=\"senha\" name=\"senha\" placeholder=\"") + myConfig::config.getPWDHided() + String("\" class=\"form-field\">"));
        client.println("<br>");
        client.println("<div class=\"space-before\"></div>");
        ...
        client.println(String("<input type=\"text\" id=\"ssid_esp\" name=\"ssid_esp\" placeholder=\"") + myConfig::config.getMySSID() + String("\" class=\"form-field\">"));
        client.println("<br>");
        client.println("<label for=\"senha_esp\" class=\"form-label-curto\">Senha:</label>");
        client.println(String("<input type=\"text\" id=\"senha_esp\" name=\"senha_esp\" placeholder=\"") + myConfig::config.getMyPWD() + String("\" class=\"form-field\">"));
        client.println("<br>");
        client.println("<div class=\"space-before\"></div>");
        ...
        client.println(String("<input type=\"text\" id=\"qtdSense\" name=\"qtdSense\" placeholder=\"") + int(myConfig::config.getQtdSensores()) + String("\" class=\"form-field\">"));
        client.println("<br>");
        client.println("<label for=\"portaSense\" class=\"form-label-x-longo\">Porta inicial:</label>");
        client.println(String("<input type=\"text\" id=\"portaSense\" name=\"portaSense\" placeholder=\"") + int(myConfig::config.getPortaIniSensores()) + String("\" class=\"form-field\">"));
        client.println("<br>");
        client.println("<br>");
        client.println("<label for=\"qtdAtua\" class=\"form-label-x-longo\">Quantidade atuadores:</label>");
        client.println(String("<input type=\"text\" id=\"qtdAtua\" name=\"qtdAtua\" placeholder=\"") + int(myConfig::config.getQtdAtuadores()) + String("\" class=\"form-field\">"));
        client.println("<br>");
        client.println("<label for=\"portaAtua\" class=\"form-label-x-longo\">Porta inicial:</label>");
        client.println(String("<input type=\"text\" id=\"portaAtua\" name=\"portaAtua\" placeholder=\"") + int(myConfig::config.getPortaIniAtuadores()) + String("\" class=\"form-field\">"));
        client.println("<br>");
        client.println("<br>");
        client.println("<label for=\"amostragem\" class=\"form-label-x-longo\">Tempo de amostragem:</label>");
        client.println(String("<input type=\"text\" id=\"amostragem\" name=\"amostragem\" placeholder=\"") + int(myConfig::config.getTempoAmostragem()) + String("\" class=\"form-field\">"));
        client.println("<br>");
        client.println("<div class=\"space-before\"></div>");
    ...
    void processPostData(String postBody)
    {
        ...
        if (chave == "RedeExterna")
        {
            while (parameters.indexOf('\n') != -1)
            {
                ...
                if (param == "ssid")
                {
                    myConfig::config.setSSID(value);
                }
                else if (param == "senha")
                {
                    myConfig::config.setPWD(value);
                }
            }
            myConfig::saveConfig();
        ...
        else if (chave == "RedeInterna")
        {
            while (parameters.indexOf('\n') != -1)
            {
                ...
                if (param == "ssid_esp")
                {
                    myConfig::config.setMySSID(value);
                }
                else if (param == "senha_esp")
                {
                    myConfig::config.setMyPWD(value);
                }
            }
            myConfig::saveConfig();
            sendResponsePOST(PAG_CONFIG_CONTROLADOR);
        ...
        else if (chave == "SensoresAtuadores")
        {
            while (parameters.indexOf('\n') != -1)
            {
                ...
                if (param == "qtdSense")
                {
                    myConfig::config.setQtdSensores(atoi(value.c_str()));
                }
                else if (param == "portaSense")
                {
                    myConfig::config.setPortaIniSensores(atoi(value.c_str()));
                }
                else if (param == "qtdAtua")
                {
                    myConfig::config.setQtdAtuadores(atoi(value.c_str()));
                }
                else if (param == "portaAtua")
                {
                    myConfig::config.setPortaIniAtuadores(atoi(value.c_str()));
                }
                else if (param == "amostragem")
                {
                    myConfig::config.setTempoAmostragem(atoi(value.c_str()));
                }
            }
            myConfig::saveConfig();
            sendResponsePOST(PAG_CONFIG_CONTROLADOR);
        ...
        else if(chave == "controlador")
        {
            ...
            while (parameters.indexOf('\n') != -1)
            {
                ...
                if (param == "nome")
                {
                    ...
                    myConfig::config.setNomeControlador(value);
                }
                else if (param == "nomeColheita")
                {
                    value = decodeSTR(value);
                    myConfig::config.setColheita(value);
                }
                else if (param == "master")
                {
                    myConfig::config.setHostMaster(value);
                }
                else if (param == "sync")
                {
                    myConfig::config.setServidorNTP(value);
                }
